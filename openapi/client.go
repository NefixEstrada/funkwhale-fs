...
// APIClient manages communication with the Funkwhale API API v1.0.0
...
type APIClient struct {
	...
	AuthAndSecurityApi *AuthAndSecurityApiService

	ContentCurationApi *ContentCurationApiService

	LibraryAndMetadataApi *LibraryAndMetadataApiService

	OtherApi *OtherApiService

	UploadsAndAudioContentApi *UploadsAndAudioContentApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AuthAndSecurityApi = (*AuthAndSecurityApiService)(&c.common)
	c.ContentCurationApi = (*ContentCurationApiService)(&c.common)
	c.LibraryAndMetadataApi = (*LibraryAndMetadataApiService)(&c.common)
	c.OtherApi = (*OtherApiService)(&c.common)
	c.UploadsAndAudioContentApi = (*UploadsAndAudioContentApiService)(&c.common)
